...
@Composable
fun OneScreenUI(navController: NavHostController) {
    Column(
        ...
        Row(
            ...
            Column {
                Text(
                    text = "That's a beautiful nature",
        ...
        Row(modifier = Modifier.padding(12.dp)) {
            Button(onClick = { navController.navigate(NavigationScreen.Welcome.route) }) {
                Text(text = "Previous")
            }
...
fun OneScreenPreview() {
    ArtSpaceTheme {
        OneScreenUI(rememberNavController())
    }
}